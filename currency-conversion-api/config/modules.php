...
return [
   ...
   |--------------------------------------------------------------------------
   |
   | Here we place all environments related to modules for access.
   |
   */
    'envs' => [
        'fixer-exchange-rate-currency-api-key' => env('FIXER_EXCHANGE_RATES_CURRENCY_API_KEY', ''),
        'fixer-exchange-rate-currency-api-domain' => env('FIXER_EXCHANGE_RATES_CURRENCY_API_DOMAIN', '')
    ]
];
